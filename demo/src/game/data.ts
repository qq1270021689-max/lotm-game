...
export const EVENTS: GameEvent[] = [
  ...
  },
  {
    ...
    choices: [
      { text: '抄起家伙动手清剿', effects: [{ k: 'money', v: 48 }, { k: 'energy', v: -15 }, { k: 'stat', stat: 'phy', v: 2 }], result: '一番恶战后你拎着鼠尾领了赏。有几道咬伤，但赏金足够买药。' },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '报警（交给值夜者）', effects: [{ k: 'favor', id: 'evelyn', v: 8 }, { k: 'money', v: 24 }, { k: 'flag', id: 'met_beyonder', v: 1 }], result: '教堂的人来得比你想象中快得多，接管现场的手法专业得可怕。一位黑风衣女士深深看了你一眼：「你做得很对。以及——今晚你什么都没看见。」他们给了你一笔「拾金不昧」的谢礼。' },
